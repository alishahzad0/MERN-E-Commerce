  ...
  render() {
    ...
    return (
      <div className='sell'>
        ...
        <h3 className='text-uppercase'>Become A Digithrift Store Seller!</h3>
        <hr />
        <Row>
            ...
            <Row>
              <Col xs='12' className='order-2 order-md-1 text-md-center mb-3'>
                <div className='agreement-banner-text'>
                  <h3>Would you like to sell your refurbished products on DigiThrift Store!</h3>
                  <h5>Enhance your business with DigiThrift Store</h5>
                  <b>Visit Now</b>
                </div>
              </Col>
